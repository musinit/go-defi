...
func (_Bindings *BindingsTransactor) MintOnDeposit(opts *bind.TransactOpts, _account common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "mintOnDeposit", _account, _amount)
}

// MintOnDeposit is a paid mutator transaction binding the contract method 0x94362e8b.
//
// Solidity: function mintOnDeposit(address _account, uint256 _amount) returns()
func (_Bindings *BindingsSession) MintOnDeposit(_account common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.MintOnDeposit(&_Bindings.TransactOpts, _account, _amount)
}

// MintOnDeposit is a paid mutator transaction binding the contract method 0x94362e8b.
//
// Solidity: function mintOnDeposit(address _account, uint256 _amount) returns()
func (_Bindings *BindingsTransactorSession) MintOnDeposit(_account common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.MintOnDeposit(&_Bindings.TransactOpts, _account, _amount)
}
